...
public class R4_RigContainer extends AbstractContainerMenu implements IRigContainer {
    public final static int ROW_NUM = 4; //swap per row count
    ...
    public R4_RigContainer(int windowId, Inventory inv) {
        super(ModContainers.ARMOR_R4.get(), windowId);  // Swap per row count
