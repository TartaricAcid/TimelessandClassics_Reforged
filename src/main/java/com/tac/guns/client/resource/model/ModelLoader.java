...
public class ModelLoader {
    ...
    public static BedrockGunModel loadBedrockGunModel(ResourceLocation metaLocation) throws IOException {
        try (InputStream stream = Minecraft.getInstance().getResourceManager().open(metaLocation)) {
            ...
            try (InputStream stream1 = Minecraft.getInstance().getResourceManager().open(modelLocation)) {
    ...
    public static BedrockAttachmentModel loadBedrockAttachmentModel(ResourceLocation modelLocation, ResourceLocation textureLocation) throws IOException {
        ...
        //load model
        try (InputStream stream = Minecraft.getInstance().getResourceManager().open(modelLocation)) {
