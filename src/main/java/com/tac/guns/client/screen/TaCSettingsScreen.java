...
//                    GunOptions.SIZE_Icon_POS
    ...
    public TaCSettingsScreen(Screen p_i225929_1_, Options p_i225929_2_) {
        super(p_i225929_1_, p_i225929_2_, Component.translatable("tac.options.screenFormat"));
    }
    ...
    protected void init() {
        ...
        if (InputConstants.isRawMouseInputSupported()) {
            this.optionsList.addSmall(Stream.concat(Arrays.stream(OPTIONS), Stream.of(new OptionInstance[]{})).toArray((p_96225_) -> {
                return new OptionInstance[p_96225_];
            }));
        } else {
