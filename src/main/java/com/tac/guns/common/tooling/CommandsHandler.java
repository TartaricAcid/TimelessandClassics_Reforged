...
public class CommandsHandler {
    ...
    public void setCatCurrentIndex(int catCurrentIndex) {
        this.catCurrentIndex = catCurrentIndex;
    }

    public boolean catInGlobal(int index) {
        return catGlobals.containsKey(Integer.valueOf(index));
    }
