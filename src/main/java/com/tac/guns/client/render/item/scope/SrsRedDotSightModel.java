 ...
 */
public class SrsRedDotSightModel implements IOverrideModel {
        ...
        */
        ...
        if (transformType.firstPerson() && entity.equals(Minecraft.getInstance().player)) {
            ...
            matrixStack.pushPose();
            {
                ...
                double scale = 5.25 - 4.2374825 + scopeData.getReticleSizeMod();
                ...
                matrixStack.mulPose(Vector3f.YP.rotationDegrees(GunRenderingHandler.get().newSwayYaw * 0.8f));
                matrixStack.mulPose(Vector3f.ZN.rotationDegrees(GunRenderingHandler.get().newSwayPitch * 0.8f));
