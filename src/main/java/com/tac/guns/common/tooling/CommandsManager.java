...
public class CommandsManager {
        ...
        LiteralArgumentBuilder<CommandSourceStack> tacCommander
                ...
                .then(Commands.literal("setCat").then(Commands.argument("catToSet", MessageArgument.message())
                        .executes(commandContext -> {
                            ...
                            int responseCat;
                            try {
                                responseCat = Integer.parseInt(iTextComponent.getString());
                        ...
                        .then(Commands.literal("setMode")
                                .then(Commands.argument("modeName", MessageArgument.message())//
                                        .executes(commandContext ->
                                        {
                                            ...
                                            try {
                                                mode = GunEditor.TaCWeaponDevModes.valueOf(MessageArgument.getMessage(commandContext, "modeName").getString());
                                            } catch (Exception e) {
                        ...
                        .then(Commands.literal("setElementIndex")
                                .then(Commands.argument("modeName", MessageArgument.message())//
                                        .executes(commandContext ->
                                        {
                                            ...
                                            try {
                                                GuiEditor.get().currElement = Integer.parseInt(iTextComponent.getString());
                                            } catch (Exception e) {
                                                sendMessage(commandContext, "INPUT WAS NOT AN INTEGER, PLEASE REFER TO DOCUMENTATION");
                                            }
                        ...
                        .then(Commands.literal("setElementIndex")
                                .then(Commands.argument("modeName", MessageArgument.message())//
                                        .executes(commandContext ->
                                        {
                                            ...
                                            Component iTextComponent = MessageArgument.getMessage(commandContext, "modeName");
                                            try {
                                                ObjectRenderEditor.get().currElement = Integer.parseInt(iTextComponent.getString());
                                            } catch (Exception e) {
                                                sendMessage(commandContext, "INPUT WAS NOT AN INTEGER, PLEASE REFER TO DOCUMENTATION");
                                            }
    ...
    static int manageCat(CommandContext<CommandSourceStack> commandContext, int cat) throws CommandSyntaxException {
        MutableComponent finalText = Component.translatable("chat.type.announcement",
                commandContext.getSource().getDisplayName(), Component.literal("Added Cat: " + cat));

        if (CommandsHandler.get().catInGlobal(cat)) {
            CommandsHandler.get().setCatCurrentIndex(cat);
        } else
            finalText = Component.translatable("chat.type.announcement",
                    commandContext.getSource().getDisplayName(), Component.literal("Cat: " + cat + " Doesn't exist yet."));

        Entity entity = commandContext.getSource().getEntity();
        if (entity != null) {
            commandContext.getSource().getServer().getPlayerList().broadcastChatMessage(finalText, entity);
